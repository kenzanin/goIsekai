...
return function(data)
	...
	if pluginIcon ~= "" then
		emit(
			' <img src="'
				.. h(pluginIcon)
				.. '" alt="" class="inline h-3.5 w-3.5 rounded-sm object-cover align-[-1px]">'
		)
	end
	if pluginName ~= "" then
