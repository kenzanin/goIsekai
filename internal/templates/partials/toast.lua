...
local TOAST_ITEM_BASE =
	"toast-item pointer-events-auto flex items-start gap-2.5 w-80 max-w-[calc(100vw-2rem)] bg-neutral-900 border border-neutral-700 rounded-lg shadow-xl p-3 pr-2.5 relative overflow-hidden"
local TOAST_ICON_BASE =
