...
--
-- Self-contained: only sandbox globals are used (http_request, json, log).
-- Sibling modules pre-execute before main.lua, so the ABI exports below are
-- visible at call time regardless of file order. To use: strip any inline
-- getAltTitles from your main.lua, drop this file into the plugin folder, and
-- add the MangaUpdates entry to alt_title_servers.
--
