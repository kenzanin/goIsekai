var htmx = (() => {
  ...
  function N(e) {
    return (
      e.matches('script') && (e.type === 'text/javascript' || e.type === 'module' || e.type === '')
    );
  }
  function I(e) {
  ...
  function tt(e, t, n) {
    return (
      Ge.exec(e.charAt(0)) && e !== 'true' && e !== 'false' && e !== 'this' && e !== n && t !== '.'
    );
  }
  function nt(r, o, i) {
    if (o[0] === '[') {
  ...
  function cn(e, t) {
    ...
    let l =
      (e instanceof HTMLFormElement && e.noValidate !== true) || te(e, 'hx-validate') === 'true';
